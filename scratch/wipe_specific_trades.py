...
def main():
    ...
    def should_scrub(p):
        # Scrub if regime is UNKNOWN
        if str(p.get("regime", "UNKNOWN")).upper() == "UNKNOWN":
            return True
        # Scrub if it matches any of the specific loss order IDs
    ...
    if acc_path.exists():
        ...
        acc_data["last_change_reason"] = "Wiped UNKNOWN regime and targeted shadow losses at 13:40"

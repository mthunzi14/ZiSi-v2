...
ADDRESS = "0x13f0bcec1e2e60ec9acc3bee4d2da2fe9694a50f"
...
RESULTS_PATH = "/root/ZiSi-v2/data/pbot_sweeper_deep_analysis.json"
...
def fetch_trades(max_trades=10000):
    print(f"[FETCH] Pulling up to {max_trades} trades for pbot_sweeper...")
    trades = []
    seen = set()
    ...
    print(f"  Completed! Total fetched pbot_sweeper trades: {len(trades)}")

...
ADDRESS = "0x21d0a97aac03917e752857a551bbe5103a00e8d7"
...
RESULTS_PATH = "/root/ZiSi-v2/data/pbot_normal_deep_analysis.json"
...
def fetch_trades(max_trades=10000):
    print(f"[FETCH] Pulling up to {max_trades} trades for PBot normal wallet...")
    trades = []
    seen = set()
    ...
    print(f"  Completed! Total fetched PBot normal trades: {len(trades)}")
